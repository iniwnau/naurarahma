...
<head>
    ...
    <link
        rel="shortcut icon"
        href="{{ asset('assets-guest/images/favicon.png') }}"
        type="image/x-icon" />
...
<body>
                ...
                <div class="flex items-center justify-between w-full px-4">
                    <div>
                        <button
                            ...
                            <span
                                class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span>
                            <span
                                class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span>
                            <span
                                class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span>
    ...
    <div
        ...
        <div
            class="absolute bottom-0 left-0 w-full h-px bg-linear-to-r from-stroke/0 via-stroke to-stroke/0 dark:via-dark-3"></div>
        <div class="container mx-auto px-4">
                            ...
                            <span
                                ...
                                <svg
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M42.4875 23.0604C43.3438 23.0604 44.038 22.3662 44.038 21.5099C44.038 20.6536 43.3657 19.9595 42.4875 19.9595C41.6312 19.9595 40.9371 20.6536 40.9371 21.5099C40.9371 22.3662 41.6531 23.0604 42.4875 23.0604Z"
                                        fill="#3758F9" />
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M42.4875 33.0404C43.3438 33.0404 44.038 32.3462 44.038 31.4899C44.038 30.6336 43.3657 29.9395 42.4875 29.9395C41.6312 29.9395 40.9371 30.6336 40.9371 31.4899C40.9371 32.3462 41.6531 33.0404 42.4875 33.0404Z"
                                        fill="#3758F9" />
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M42.4875 43.0203C43.3438 43.0203 44.038 42.3262 44.038 41.4699C44.038 40.6136 43.3657 39.9194 42.4875 39.9194C41.6312 39.9194 40.9371 40.6136 40.9371 41.4699C40.9371 42.3262 41.6531 43.0203 42.4875 43.0203Z"
                                        fill="#3758F9" />
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M42.4875 53.0001C43.3438 53.0001 44.038 52.3059 44.038 51.4496C44.038 50.5933 43.3438 49.8992 42.4875 49.8992C41.6312 49.8992 40.9371 50.5933 40.9371 51.4496C40.9371 52.3059 41.6531 53.0001 42.4875 53.0001Z"
                                        fill="#3758F9" />
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                    ...
                    <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                        <div class="flex justify-center my-1 md:justify-end">
                            <p class="text-base text-gray-7">
                                ...
                                . Distributed by
                                <a href="https://themewagon.com" rel="nofollow noopner" target="_blank" class="text-gray-1 hover:underline">ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
